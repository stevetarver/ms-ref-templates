...
public class RequestInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest req, HttpServletResponse resp, Object o) throws Exception {
        String logguid = req.getHeader(LoggingTelemetryAspect.X_REQUEST_ID_HDR);
        MDC.put(LoggingTelemetryAspect.X_REQUEST_ID_KEY, Optional.ofNullable(logguid).orElseGet(() -> UUID.randomUUID().toString()));
