...
public class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleResourceNotFoundException(ResourceNotFoundException e) {
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleInvalidSignature(SignatureException signatureException) {
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleMethodArgumentNotValidException(
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleNoHandlerFoundException(
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleHttpMediaTypeNotSupportedException(
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleIllegalStateException(
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleMethodArgumentTypeMismatchException(
    ...
    @ExceptionHandler
    public ResponseEntity<JsonApiErrorResponse> handleUnhandledThrowable(
            Throwable throwable) {
